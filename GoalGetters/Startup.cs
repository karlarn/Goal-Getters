...
namespace GoalGetters
{
    public class Startup
    {
        ...
        {
            services.AddTransient<IIFeelYouRepository, IFeelYouRepository>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "GoalGetters", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment() || env.IsEnvironment("Local"))
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "GoalGetters v1"));
            }
